...
# just looking at the top 1000 hits for now
...
ggplot(aes(x=name_1006, y=frequency, fill=name_1006, alpha=0.5)) + 
  geom_bar(stat = "identity", width=0.4) + coord_flip() +  labs(title = "Top 10 GO Terms", y = "Percentage of Upregulated Genes in HD6h Wheat", x = "Molecular Function") + theme(legend.position="none")
...
ggplot(aes(x=name_1006, y=frequency, fill=name_1006, alpha=0.5)) + 
  geom_bar(stat = "identity", width=0.4) + coord_flip() +  labs(title = "Top 10 GO Terms", y = "Percentage of Upregulated Genes in HD6h Wheat", x = "Biological Process") + theme(legend.position="none")
...
ggplot(aes(x=name_1006, y=frequency, fill=name_1006, alpha=0.5)) + 
  geom_bar(stat = "identity", width=0.4) + coord_flip() +  labs(title = "Top 10 GO Terms", y = "Percentage of Upregulated Genes in HD6h Wheat", x = "Cellular Component") + theme(legend.position="none")
...
ggplot(aes(x=name_1006, y=frequency, fill=name_1006, alpha=0.5)) + 
  geom_bar(stat = "identity", width=0.4) + coord_flip() +  labs(title = "Top 10 GO Terms", y = "Percentage of Downregulated Genes in HD6h Wheat", x = "Molecular Function") + theme(legend.position="none")
...
ggplot(aes(x=name_1006, y=frequency, fill=name_1006, alpha=0.5)) + 
  geom_bar(stat = "identity", width=0.4) + coord_flip() +  labs(title = "Top 10 GO Terms", y = "Percentage of Downregulated Genes in HD6h Wheat", x = "Biological Process") + theme(legend.position="none")
...
ggplot(aes(x=name_1006, y=frequency, fill=name_1006, alpha=0.5)) + 
  geom_bar(stat = "identity", width=0.4) + coord_flip() +  labs(title = "Top 10 GO Terms", y = "Percentage of Downregulated Genes in HD6h Wheat", x = "Cellular Component") + theme(legend.position="none")
